        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
          ...
          <div className="space-y-4 col-span-1 md:col-span-2">
            ...
            <div className="flex justify-between items-center">
              <div>
                <p className="text-md bg-primary/50 font-bold px-4 py-2 rounded-sm text-black/90">{selectedArticle?.category}</p>
              </div>
              <div>
                <p className="text-md font-bold text-primary text-lg">$ {selectedArticle?.price.toFixed(2)}</p>
            </div>
            </div>
